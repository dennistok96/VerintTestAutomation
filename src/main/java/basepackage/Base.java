...
public class Base {
    ...
    public void explicitWaitElementClickable(WebDriver driver, By locator) {
        WebDriverWait wait = new WebDriverWait(driver, 15);
        wait.until(ExpectedConditions.refreshed(
                ExpectedConditions.elementToBeClickable(locator)));
    }

    public void explicitWaitElementPresent(WebDriver driver, WebElement element, String text) {
